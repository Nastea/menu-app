...
export const tesaliaMenuSeedCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      item("item-tesalia-carne-rece-3", "Vitello tonnato", "1/80/30", 200),
      item(
      ...
      item("item-tesalia-carne-rece-5", "Brezoala", "1/60/10/10", 195),
      item(
      ...
      item("item-tesalia-carne-rece-7", "Asortat de carne Duo", "1/90/10/10", 190),
      item("item-tesalia-carne-rece-8", "Mixt de antipasti", "portie", 230),
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      item("item-tesalia-calde-4", "Cordon Blue", "1/80", 170),
      item(
      ...
      item("item-tesalia-calde-6", "Piept de porc cu sos barbecue", "1/90/50", 170),
      item(
      ...
      item("item-tesalia-calde-8", "Beef Wellington", "1/120", 200),
  ...
  },
  {
    ...
    items: [
      ...
      item("item-tesalia-principal-3", "Piept de porc pe polento", "1/80/80/30", 195),
      item(
      ...
      item("item-tesalia-principal-6", "Medalion din vitel portionat", "portie", 260),
      item("item-tesalia-principal-7", "Beef Wellington", "portie", 200),
      item(
      ...
      item("item-tesalia-principal-10", "Platou cu carne", "portie", 190),
    ],
  },
  {
